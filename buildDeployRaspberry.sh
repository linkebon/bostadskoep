...
ssh pi@${TARGET_SERVER} "sudo ${APP_SCRIPTS_HOME}/STOP_BOSTADSKOEP.sh;rm -rf ${APP_HOME}/${APP_NAME};"

echo 'Uploading new version'
scp -rp build pi@${TARGET_SERVER}:${APP_HOME}
echo 'Upload done'
ssh pi@${TARGET_SERVER} "mv ${APP_HOME}/build ${APP_HOME}/${APP_NAME};sudo ${APP_SCRIPTS_HOME}/START_BOSTADSKOEP.sh;"
